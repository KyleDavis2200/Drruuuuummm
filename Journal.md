...
<img width="808" height="690" alt="image" src="https://github.com/user-attachments/assets/8d228797-c465-43e5-8781-6c278b76fc00" />
This was my sketch of the robot's weapon's side profile. This profile has a 50mm outer diameter and features an asymmetric design to maximize bite. I swept this profile along the helix to create a unique weapon design while still allowing it to be balanced. I also went in and put a pocket in each side of the drum, with a solid center in the middle, to save weight.
<img width="670" height="546" alt="image" src="https://github.com/user-attachments/assets/1a4d5c82-012c-44dc-8716-f031d158a874" />


<img width="907" height="607" alt="image" src="https://github.com/user-attachments/assets/07924fb3-34df-4b33-9afc-edf6d8021810" />
I started modelling the frame by making a master sketch which I would then use as the base for rest of the features.
<img width="622" height="584" alt="image" src="https://github.com/user-attachments/assets/1455a5bf-c2bc-4a2e-9edb-358017ca2b7b" />
Affter a few extrusions and fillets, the robot is starting to take shape.
